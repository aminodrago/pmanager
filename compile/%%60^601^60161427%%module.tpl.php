<?php /* Smarty version 2.6.16, created on 2011-07-06 21:38:01
         compiled from /home/mensajes/public_html/gestion/activecollab/application/modules/timetracking/views/timetracking_module_admin/module.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'title', '/home/mensajes/public_html/gestion/activecollab/application/modules/timetracking/views/timetracking_module_admin/module.tpl', 1, false),array('block', 'add_bread_crumb', '/home/mensajes/public_html/gestion/activecollab/application/modules/timetracking/views/timetracking_module_admin/module.tpl', 2, false),array('block', 'lang', '/home/mensajes/public_html/gestion/activecollab/application/modules/timetracking/views/timetracking_module_admin/module.tpl', 7, false),array('function', 'include_template', '/home/mensajes/public_html/gestion/activecollab/application/modules/timetracking/views/timetracking_module_admin/module.tpl', 5, false),array('function', 'cycle', '/home/mensajes/public_html/gestion/activecollab/application/modules/timetracking/views/timetracking_module_admin/module.tpl', 16, false),array('function', 'role_permission_value', '/home/mensajes/public_html/gestion/activecollab/application/modules/timetracking/views/timetracking_module_admin/module.tpl', 18, false),array('modifier', 'clean', '/home/mensajes/public_html/gestion/activecollab/application/modules/timetracking/views/timetracking_module_admin/module.tpl', 17, false),)), $this); ?>
<?php $this->_tag_stack[] = array('title', array()); $_block_repeat=true;smarty_block_title($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Time Tracking Module<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_title($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack);  $this->_tag_stack[] = array('add_bread_crumb', array()); $_block_repeat=true;smarty_block_add_bread_crumb($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Details<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_add_bread_crumb($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['role']->getName())) ? $this->_run_mod_handler('clean', true, $_tmp) : smarty_modifier_clean($_tmp)); ?>
        ...
        <td class="permission"><?php echo smarty_function_role_permission_value(array('role' => $this->_tpl_vars['role'],'permission' => 'use_time_reports'), $this);?>
</td>
        <td class="permission"><?php echo smarty_function_role_permission_value(array('role' => $this->_tpl_vars['role'],'permission' => 'manage_time_reports'), $this);?>
</td>
      </tr>
