<?php /* Smarty version 2.6.16, created on 2011-07-05 22:49:26
         compiled from C:%5Cwamp%5Cwww%5Cproject%5Cactivecollab/application/modules/status/views/status_module_admin/module.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'title', 'C:\\wamp\\www\\project\\activecollab/application/modules/status/views/status_module_admin/module.tpl', 1, false),array('block', 'add_bread_crumb', 'C:\\wamp\\www\\project\\activecollab/application/modules/status/views/status_module_admin/module.tpl', 2, false),array('block', 'lang', 'C:\\wamp\\www\\project\\activecollab/application/modules/status/views/status_module_admin/module.tpl', 7, false),array('function', 'include_template', 'C:\\wamp\\www\\project\\activecollab/application/modules/status/views/status_module_admin/module.tpl', 5, false),array('function', 'cycle', 'C:\\wamp\\www\\project\\activecollab/application/modules/status/views/status_module_admin/module.tpl', 15, false),array('function', 'role_permission_value', 'C:\\wamp\\www\\project\\activecollab/application/modules/status/views/status_module_admin/module.tpl', 17, false),array('modifier', 'clean', 'C:\\wamp\\www\\project\\activecollab/application/modules/status/views/status_module_admin/module.tpl', 16, false),)), $this); ?>
<?php $this->_tag_stack[] = array('title', array()); $_block_repeat=true;smarty_block_title($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Status Module<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_title($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack);  $this->_tag_stack[] = array('add_bread_crumb', array()); $_block_repeat=true;smarty_block_add_bread_crumb($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Details<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_add_bread_crumb($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
  ...
  <div class="section_container">
    <table class="module_role_permissions">
      <tr>
        ...
        <th class="permission"><?php $this->_tag_stack[] = array('lang', array()); $_block_repeat=true;smarty_block_lang($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Can post updates?<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_lang($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></th>
      </tr>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['role']->getName())) ? $this->_run_mod_handler('clean', true, $_tmp) : smarty_modifier_clean($_tmp)); ?>
        ...
        <td class="permission"><?php echo smarty_function_role_permission_value(array('role' => $this->_tpl_vars['role'],'permission' => 'can_use_status_updates'), $this);?>
</td>
      </tr>
